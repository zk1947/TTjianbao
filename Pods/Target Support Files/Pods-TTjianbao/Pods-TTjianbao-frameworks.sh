...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${PODS_ROOT}/GDTActionSDK/GDTActionSDK/Frameworks/GDTActionSDK.framework"
  install_framework "${PODS_ROOT}/NELivePlayer/LivePlayer_iOS_SDK_v2.4.4/NELivePlayerFramework.framework"
