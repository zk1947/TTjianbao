...
-(void)jeneralAccountLoginView{
    ...
    UIImageView* accountima=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"ic_phone"]];
    ...
    [accountima mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.size.mas_equalTo(CGSizeMake(19,23));
    ...
    UIImageView* passwordima=[[UIImageView alloc]initWithImage:[UIImage imageNamed:@"ic_mima"]];
    passwordima.backgroundColor=[UIColor clearColor];
    [passwordView addSubview:passwordima];
    ...
    [passwordima mas_makeConstraints:^(MASConstraintMaker *make) {
    ...
    [password mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(passwordima.mas_right).offset(10);
...
-(void)send{
    ...
    [HttpRequestTool postWithURL:FILE_BASE_STRING(@"/login/smsAndReg") Parameters:parameters requestSerializerType:RequestSerializerTypeHttp successBlock:^(RequestModel *respondObject) {
