//
//  JHBusinessPublishTimePickerView.m
//  TTjianbao
//
...
@interface JHBusinessPublishTimePickerView()<UIPickerViewDataSource, UIPickerViewDelegate>
@property (nonatomic, assign)NSInteger selectedIndex_0;
@end
@implementation JHBusinessPublishTimePickerView
- (void)setupUI
{
    [super setupUI];
...
{
    return self.normalModel.publishStartTimeList.count;
}
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(nullable UIView *)view
{
    ...
    JHPublishTimeListModel* firstModel = self.normalModel.publishStartTimeList[row];
...
- (void)selectedOk {
    ...
    if(self.sureClickBlock2){
        JHPublishTimeListModel* firstModel = self.normalModel.publishStartTimeList[_selectedIndex_0];
