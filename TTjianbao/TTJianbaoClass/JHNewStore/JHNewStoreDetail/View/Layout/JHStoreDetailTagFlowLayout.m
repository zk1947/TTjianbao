...
@interface JHStoreDetailTagFlowLayout(){
    //在居中对齐的时候需要知道这行所有cell的宽度总和
    CGFloat _sumCellWidth ;
}
@end
@implementation JHStoreDetailTagFlowLayout
- (void)prepareLayout {
    [super prepareLayout];
...
- (NSArray *)layoutAttributesForElementsInRect:(CGRect)rect {
    ...
    for (NSUInteger index = 0; index < layoutAttributes.count ; index++) {
        ...
        UICollectionViewLayoutAttributes *previousAttr = index == 0 ? nil : layoutAttributes[index-1]; // 上一个cell 的位置信息
