...
@protocol JHZeroAuctionListCellDelegate <NSObject>
- (void)JHStealTowerListCellLeaveTopd;
@end

@interface JHZeroAuctionListCell : UITableViewCell

@property (nonatomic,   weak) id<JHZeroAuctionListCellDelegate> delegate;
