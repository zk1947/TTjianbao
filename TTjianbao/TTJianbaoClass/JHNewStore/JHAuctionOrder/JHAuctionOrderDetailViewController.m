//
//  JHAuctionOrderDetailViewController.m
//  TTjianbao
//
...
@interface JHAuctionOrderDetailViewController ()<JHOrderConfirmViewDelegate>
{
    JHAuctionOrderConfirmView * orderView;
    CommAlertView*  alert;
...
@implementation JHAuctionOrderDetailViewController
...
//        self.title = @"确认订单";
    ...
    for ( UIViewController *vc in arr) {
        if ([vc isKindOfClass:[JHAuctionOrderDetailViewController class]]&&vc != self) {
            [arr removeObject:vc];
...
-(void)initContentView{
    orderView=[[JHAuctionOrderConfirmView alloc]init];
