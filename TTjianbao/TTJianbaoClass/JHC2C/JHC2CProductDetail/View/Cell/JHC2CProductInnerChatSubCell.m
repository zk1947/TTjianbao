//
//  JHC2CProductInnerChatSubCell.m
//  TTjianbao
//
...
@interface JHC2CProductInnerChatSubCell ()<UIGestureRecognizerDelegate>
...
@implementation JHC2CProductInnerChatSubCell
...
- (void)makeLayouts {
    ...
    [_likeButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerY.equalTo(_bottomTimeLabel);
