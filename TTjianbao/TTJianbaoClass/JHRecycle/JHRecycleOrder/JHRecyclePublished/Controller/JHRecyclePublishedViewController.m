//
//  JHRecyclePublishedViewController.m
//  TTjianbao
//
...
@interface JHRecyclePublishedViewController ()<JXCategoryViewDelegate, JXCategoryListContainerViewDelegate>
/** 菜单栏*/
...
@implementation JHRecyclePublishedViewController
...
- (void)configUI {
    ...
    self.categoryView.titles = @[@"已发布", @"已失效"];
...
- (NSMutableArray *)vcArr {
    if (_vcArr == nil) {
        ...
        JHRecycleMinePublishedViewController *publishVc = [[JHRecycleMinePublishedViewController alloc] init];
        publishVc.listType = @"0";
        [_vcArr addObject:publishVc];
        JHRecycleMinePublishedViewController *invalidVc = [[JHRecycleMinePublishedViewController alloc] init];
        invalidVc.listType = @"1";
        [_vcArr addObject:invalidVc];
    }
    return _vcArr;
}
