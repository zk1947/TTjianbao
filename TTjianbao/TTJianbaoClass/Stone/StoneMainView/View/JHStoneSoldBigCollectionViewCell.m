////
////  JHStoneSoldBigCollectionViewCell.m
////  TTjianbao
////
...
//
//@interface JHStoneSoldBigCollectionViewCell ()
//{
...
//@end
//
//@implementation JHStoneSoldBigCollectionViewCell
...
//            make.centerY.equalTo(_buyName).offset(0);
//            make.size.mas_equalTo(CGSizeMake(12, 12));
//            make.right.equalTo(_buyName.mas_left).offset(-5);
//        }];
//
...
//            make.top.equalTo(_title.mas_bottom).offset(0);
//            make.height.offset(30);
//            make.right.equalTo(_headImage.mas_left).offset(-5);
//        }];
//
//
//
