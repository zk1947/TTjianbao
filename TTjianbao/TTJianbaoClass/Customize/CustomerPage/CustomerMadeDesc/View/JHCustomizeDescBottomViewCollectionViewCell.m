//
//  JHCustomizeDescBottomViewCollectionViewCell.m
//  TTjianbao
//
...
@interface JHCustomizeDescBottomViewCollectionViewCell ()
@property (nonatomic, strong) NSMutableArray             *btnArray;
@property (nonatomic, copy  ) customerDescBtnActionBlock  descBtnBlock;
@end

@implementation JHCustomizeDescBottomViewCollectionViewCell
...
//            [button setImage:[UIImage imageNamed:@"sq_toolbar_icon_like_selected"] forState:UIControlStateSelected];
        ...
        [button mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.left.equalTo(self.contentView.mas_left).offset(25.f+i*((ScreenWidth -25.f*2.f-10.f)/2.f + 10.f));
