//
//  JHHonnerCerDetailPeopleTableViewCell.m
//  TTjianbao
//
...
@interface JHHonnerCerDetailPeopleTableViewCell ()
@property (nonatomic, strong) UILabel *titleLabel;
@property (nonatomic, strong) UILabel *subTitleLabel;
@end

@implementation JHHonnerCerDetailPeopleTableViewCell
