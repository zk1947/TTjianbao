//
//  JHHonnerCerDetailOrignTableViewCell.m
//  TTjianbao
//
...
@interface JHHonnerCerDetailOrignTableViewCell ()
@property (nonatomic, strong) UILabel *titleLabel;
@property (nonatomic, strong) UILabel *subTitleLabel;
@end

@implementation JHHonnerCerDetailOrignTableViewCell
