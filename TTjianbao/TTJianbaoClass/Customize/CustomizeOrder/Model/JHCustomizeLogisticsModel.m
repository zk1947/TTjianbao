...
@implementation JHCustomizeLogisticsModel
@end

@implementation JHCustomizeLogisticsUserExpressInfoModel
+ (NSDictionary *)mj_objectClassInArray {
    return @{
        @"data" : [JHCustomizeLogisticsDataModel class]
    };
}
@end

@implementation JHCustomizeLogisticsDataModel
@end


@implementation JHCustomizeLogisticsFinalModel

+ (NSArray<JHCustomizeLogisticsFinalModel *>*)setViewModelImpl:(JHCustomizeLogisticsModel *)model {
    NSMutableArray *arr = [[NSMutableArray alloc] init];
    /// 用户
    JHCustomizeLogisticsFinalModel *userModel = [[JHCustomizeLogisticsFinalModel alloc] init];
    ...
    /// 商家
    JHCustomizeLogisticsFinalModel *sellerModel = [[JHCustomizeLogisticsFinalModel alloc] init];
    ...
    /// 平台
    JHCustomizeLogisticsFinalModel *platModel = [[JHCustomizeLogisticsFinalModel alloc] init];
