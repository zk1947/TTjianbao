//
//  JHNewOrderListViewController.m
//  TTjianbao
//
...
@interface JHNewOrderListViewController ()<JXCategoryViewDelegate, JXCategoryListContainerViewDelegate>
...
@property (nonatomic, strong) NSMutableArray <JHNewOrderSubListViewController*>*vcArr;

@end

@implementation JHNewOrderListViewController
...
- (void)viewDidLoad {
    ...
    self.cateArr = [[JHCustomizeOrderModel getNewOrderListCateArry:self.isSeller] mutableCopy];
...
- (void)setupTitleCategoryView {
    ...
    for (JHOrderCateMode *mode in self.cateArr) {
        JHNewOrderSubListViewController *vc =  [[JHNewOrderSubListViewController alloc]init];
