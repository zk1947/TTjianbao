//
//  JHCustomizeCheckStuffDetailNameTableViewCell.m
//  TTjianbao
//
...
@interface JHCustomizeCheckStuffDetailNameTableViewCell ()
@property (nonatomic, strong) UILabel *nameLabel;
@property (nonatomic, strong) UILabel *subNameLabel;
@end

@implementation JHCustomizeCheckStuffDetailNameTableViewCell
...
- (void)setViewModel:(id)viewModel {
    ...
    self.subNameLabel.text = NONNULL_STR(string);
}
