//
//  JHCustomizeCheckStuffDetailCagetoryTableViewCell.m
//  TTjianbao
//
...
@interface JHCustomizeCheckStuffDetailCagetoryTableViewCell ()
@property (nonatomic, strong) UILabel *nameLabel;
@property (nonatomic, strong) UILabel *subNameLabel;
@end

@implementation JHCustomizeCheckStuffDetailCagetoryTableViewCell
