//
//  JHCustomizeCheckProgramPictsTableViewCell.m
//  TTjianbao
//
...
@interface JHCustomizeCheckCollectionViewCell : UICollectionViewCell
@property (nonatomic, strong) UIImageView *iconImageView;
@property (nonatomic, strong) UIView      *videoCoverView;
@property (nonatomic,   weak) UIImageView *videoIconImageView;
@property (nonatomic, strong) JHCustomizeCheckProgramPictsModel *model;
- (void)setViewModel:(id)viewModel;
@end

@implementation JHCustomizeCheckCollectionViewCell
...
- (void)setViewModel:(id)viewModel {
    JHCustomizeCheckProgramPictsModel *model = [JHCustomizeCheckProgramPictsModel cast:viewModel];
    self.model = model;
    if (model.type == 0) { /// 图片
...
@interface JHCustomizeCheckProgramPictsTableViewCell ()<
...
@implementation JHCustomizeCheckProgramPictsTableViewCell
...
- (void)setupViews {
    ...
    [mpCollectionView registerClass:[JHCustomizeCheckCollectionViewCell class] forCellWithReuseIdentifier:NSStringFromClass([JHCustomizeCheckCollectionViewCell class])];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    JHCustomizeCheckCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([JHCustomizeCheckCollectionViewCell class]) forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    for (JHCustomizeCheckProgramPictsModel *model in self.dataSourceArray) {
