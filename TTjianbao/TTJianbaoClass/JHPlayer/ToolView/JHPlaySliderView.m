...
/** 滑块 */
@property (nonatomic, strong) JHSliderButton *sliderBtn;
...
@end
@implementation JHPlaySliderView
...
- (JHSliderButton *)sliderBtn {
    if (!_sliderBtn) {
        _sliderBtn = [JHSliderButton buttonWithType:UIButtonTypeCustom];
