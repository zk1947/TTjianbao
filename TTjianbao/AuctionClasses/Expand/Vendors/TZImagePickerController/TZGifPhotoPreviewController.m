...
- (void)viewDidLoad {
    ...
    self.backButton = [[UIButton alloc] initWithFrame:CGRectMake(10, UI.statusBarHeight, 50, 40)];
    [self.backButton setImage:[UIImage imageNamed:@"icon_video_left_back"] forState:UIControlStateNormal];
