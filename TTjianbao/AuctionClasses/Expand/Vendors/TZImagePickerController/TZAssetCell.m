...
- (UIView *)bottomView {
    if (_bottomView == nil) {
        ...
        bottomView.backgroundColor = [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:0.4];
...
- (void)layoutSubviews {
    ...
    _videoImgView.frame = CGRectMake(8, 4.5, 11, 8);
...
- (void)setModel:(TZAlbumModel *)model {
    ...
    self.titleLabel.text = [NSString stringWithFormat:@"%@  (%zd)",model.name,model.count];
...
- (UIImageView *)posterImageView {
    if (_posterImageView == nil) {
        _posterImageView = [UIImageView jh_imageViewAddToSuperview:self.contentView];
        [_posterImageView jh_cornerRadius:8];
