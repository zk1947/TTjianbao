...
- (void)configDefaultSetting {
    ...
    self.iconThemeColor = [UIColor colorWithRed:254 / 255.0 green:225 / 255.0 blue:0 / 255.0 alpha:1.0];
...
- (void)configDefaultImageName {
    ...
    self.photoOriginSelImageName = @"photo_sel_photoPickerVc";
}
...
+ (BOOL)tz_isIPhoneX {
    return  UI.bottomSafeAreaHeight != 0;
}
