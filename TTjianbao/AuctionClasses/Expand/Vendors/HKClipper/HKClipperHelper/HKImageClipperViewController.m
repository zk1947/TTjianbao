...
- (instancetype)initWithBaseImg:(UIImage *)baseImg resultImgSize:(CGSize)resultImgSize clipperType:(ClipperType)type {
    ...
    if (self) {        
        ...
        _clipperView.frame = self.view.bounds;// CGRectMake(0, 64, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height - 64);
        ...
        _clipperView.center = self.view.center;
    }
    return self;
}
