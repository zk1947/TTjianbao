...
-(void)buildTags{
    ...
    for (int i = 0; i<_dataA.count; i++) {
        ...
        UIButton *button =[UIButton LXButtonNoFrameWithTitle:_dataA[i] titleFont:self.tagFont Image:nil backgroundImage:nil backgroundColor:[CommHelp toUIColorByStr:@"#f0f0f0"] titleColor:[CommHelp toUIColorByStr:@"#666666"]];
        button.layer.cornerRadius = 14;
//        button.layer.borderColor = [CommHelp toUIColorByStr:@"#ff4200"].CGColor;//设置边框颜色
