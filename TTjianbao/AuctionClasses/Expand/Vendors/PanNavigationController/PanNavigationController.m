...
{
    self.swiper.receiveTouchViewController = viewcontroller;
}

- (void)setPopAssignViewController:(UIViewController *)popAssignViewController{
    self.swiper.popAssignViewController = popAssignViewController;
}
@end
