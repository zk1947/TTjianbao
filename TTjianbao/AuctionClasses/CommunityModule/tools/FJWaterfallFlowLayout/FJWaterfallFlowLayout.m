...
@property(nonatomic, strong) NSMutableArray *attriArr;
...
-(void)setColCount:(CGFloat)colCount{
    ...
    _colCount=colCount;
    self.colunMaxYDic=[NSMutableDictionary dictionaryWithCapacity:10];
...
{
    [super prepareLayout];
//    NSLog(@"11111111prepareLayout");
    [self.attriArr removeAllObjects];
...
- (nullable UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath;
{
    ...
    if (self.isShowDefaultImage) {
        attri.frame = CGRectMake(x, y, ScreenW, height);
    }else {
...
{
//    NSLog(@"11111111layoutAttributesForElementsInRect");
