...
@interface JHStoreCollectionGridCCell ()
...
- (void)setCurData:(CStoreCollectionData *)curData {
    ...
    _curData = curData;
    [_imgView jhSetImageWithURL:[NSURL URLWithString:curData.coverImgInfo.imgUrl] placeholder:kDefaultCoverImage];
