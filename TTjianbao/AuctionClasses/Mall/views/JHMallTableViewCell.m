...
@implementation JHMallTableViewCell
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _restoreImage.image=[UIImage imageNamed:@"mall_bigcell_restonei_img"];
        ...
        [_restoreImage mas_makeConstraints:^(MASConstraintMaker *make) {
            make.size.mas_equalTo(CGSizeMake(58, 23));
...
-(void)setLiveRoomMode:(JHLiveRoomMode *)liveRoomMode{
    ...
    if (!_redPacketImage.hidden) {
        [_redPacketImage.layer addAnimation:[AnimotionObject shakeAnimalGroup] forKey:nil];
    }
