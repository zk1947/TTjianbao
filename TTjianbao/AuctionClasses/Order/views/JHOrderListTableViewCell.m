...
@interface JHOrderListTableViewCell ()
{
...
@end
@implementation JHOrderListTableViewCell
...
//    NSString * url=[[UserInfoRequestManager sharedInstance] findOrderCategoryIcon:_orderMode.orderCategory];
